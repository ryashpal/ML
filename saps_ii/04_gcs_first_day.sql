...
DROP MATERIALIZED VIEW IF EXISTS saps_ii.gcsfirstday CASCADE;
create materialized view saps_ii.gcsfirstday as
with base as
(
  SELECT pvt.STAY_ID
  , pvt.charttime
  ...
  , case
    ...
    as VALUENUM
  , l.CHARTTIME
  from mimiciv.CHARTEVENTS l

  -- get intime for charttime subselection
  inner join mimiciv.icustays b
