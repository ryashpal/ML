...
DROP TABLE IF EXISTS saps_ii.ventsettings CASCADE;
CREATE TABLE saps_ii.ventsettings AS
select
  stay_id, charttime
...
DROP TABLE IF EXISTS saps_ii.VENTDURATIONS CASCADE;
create TABLE saps_ii.ventdurations as
with vd0 as
(
  select
    stay_id
