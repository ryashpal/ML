DROP MATERIALIZED VIEW IF EXISTS saps_ii.bloodgasfirstdayarterial CASCADE;
CREATE MATERIALIZED VIEW saps_ii.bloodgasfirstdayarterial AS
with stg_spo2 as
(
...
select bg.*
  ...
  , s1.spo2
from saps_ii.bloodgasfirstday bg
